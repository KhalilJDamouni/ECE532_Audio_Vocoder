...
--               C:/Users/damounik/March23/final_video_board/final_video_board.srcs/sources_1/bd/audio_vocoder/ip/audio_vocoder_processingPath_0_0/audio_vocoder_processingPath_0_0_sim_netlist.vhdl
...
entity audio_vocoder_processingPath_0_0_processingPath is
  ...
  attribute ORIG_REF_NAME of audio_vocoder_processingPath_0_0_processingPath : entity is "processingPath";
...
begin
  axi_clk <= \^axi_clk\;
  configDataFFT(15) <= \<const0>\;
  configDataFFT(14) <= \<const0>\;
  configDataFFT(13) <= \<const0>\;
  configDataFFT(12) <= \<const0>\;
  configDataFFT(11) <= \<const0>\;
  configDataFFT(10) <= \<const0>\;
  configDataFFT(9) <= \<const1>\;
  configDataFFT(8) <= \<const1>\;
  configDataFFT(7) <= \<const0>\;
  configDataFFT(6) <= \<const1>\;
  configDataFFT(5) <= \<const0>\;
  configDataFFT(4) <= \<const1>\;
  configDataFFT(3) <= \<const0>\;
  configDataFFT(2) <= \<const1>\;
  configDataFFT(1) <= \<const1>\;
  configDataFFT(0) <= \<const1>\;
  configDataIFFT(15) <= \<const0>\;
  configDataIFFT(14) <= \<const0>\;
  configDataIFFT(13) <= \<const0>\;
  configDataIFFT(12) <= \<const0>\;
  configDataIFFT(11) <= \<const0>\;
  configDataIFFT(10) <= \<const0>\;
  configDataIFFT(9) <= \<const1>\;
  configDataIFFT(8) <= \<const1>\;
  configDataIFFT(7) <= \<const0>\;
  configDataIFFT(6) <= \<const1>\;
  configDataIFFT(5) <= \<const0>\;
  configDataIFFT(4) <= \<const1>\;
  configDataIFFT(3) <= \<const0>\;
  configDataIFFT(2) <= \<const1>\;
  configDataIFFT(1) <= \<const1>\;
...
entity audio_vocoder_processingPath_0_0 is
  ...
  attribute CHECK_LICENSE_TYPE of audio_vocoder_processingPath_0_0 : entity is "audio_vocoder_processingPath_0_0,processingPath,{}";
...
architecture STRUCTURE of audio_vocoder_processingPath_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of axi_clk : signal is "XIL_INTERFACENAME axi_clk, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN audio_vocoder_processingPath_0_0_axi_clk, INSERT_VIP 0";
...
inst: entity work.audio_vocoder_processingPath_0_0_processingPath
     port map (
      axi_clk => axi_clk,
      clk_12 => clk_12,
      configDataFFT(15 downto 0) => configDataFFT(15 downto 0),
      configDataIFFT(15 downto 0) => configDataIFFT(15 downto 0),
