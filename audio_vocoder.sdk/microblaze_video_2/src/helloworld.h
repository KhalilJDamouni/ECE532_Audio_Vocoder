...
volatile u32 mic_reg = XPAR_AXI_CHILD_4_0_BASEADDR;
volatile u32* axi_base =  (u32*) XPAR_AXI_CHILD_4_0_BASEADDR;
volatile u32* test = (u32*) XPAR_AXI_CHILD_4_0_BASEADDR;
